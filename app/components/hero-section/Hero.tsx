      ...
      <div className="text sm:w-4/5 text-center lg:text-start lg:w-[60%] flex flex-col gap-6 lg:gap-11 mb-6 lg:mb-0">
        <div className="flex flex-col gap-4 lg:gap-0">
          ...
          >
            ...
            <p>an Electrical & Computer Engineer graduate from UCT</p>
          </motion.h1>
          ...
          >
            I enjoy building practical systems and web applications that connect engineering thinking with real business needs.
          </motion.p>
        </div>
