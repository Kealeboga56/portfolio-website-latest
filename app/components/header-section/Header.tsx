      ...
      >
        <div className="flex justify-between items-center px-6 py-4 rounded-2xl bg-linear-to-r from-[#d9d9d91f] to-[#7373731f] mt-4 sm:mt-8 backdrop-blur-md std-backdrop-blur">
          ...
          <div className="gap-5 text-xl hidden sm:flex">
            <Link target="_blank" href="https://linkedin.com/in/kealeboga-motlhankane-b37873233">
              <Icon icon="hugeicons:linkedin-01" />
            </Link>
            <Link target="_blank" href="https://www.instagram.com/kea_motlhankane?igsh=aGZkemh0dnJjeGR0">
              <Icon icon="hugeicons:instagram" />
            </Link>
            <Link target="_blank" href="https://github.com/Kealeboga56">
